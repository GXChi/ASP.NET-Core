...
{
    public abstract class RepositoryBase<TEntity, TPrimaryKey> : IRepository<TEntity, TPrimaryKey> where TEntity : BaseEntity<TPrimaryKey>
    {
        /// <summary>
        /// 定义数据访问上下文对象
        /// </summary>
        protected readonly CloudNoteDbContext _dbContext;
        ...
        public RepositoryBase(CloudNoteDbContext dbContext)
        {
    ...
    {
        public RepositoryBase(CloudNoteDbContext dbContext) : base(dbContext)
        {
